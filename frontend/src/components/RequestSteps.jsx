...
const RequestSteps = () => {
  return (
    <div className="py-12 text-center">
      ...
      {/* Steps Section */}
      <div className="mx-10 flex flex-col md:flex-row justify-center items-center gap-8">
        {/* Step 1: Choose Your Ride */}
        <div className="w-1/4 h-[350px] bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg shadow-lg flex flex-col items-center">
        ...
        <div className="w-1/4 h-[350px] bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg shadow-lg flex flex-col items-center mt-8 md:mt-0">
