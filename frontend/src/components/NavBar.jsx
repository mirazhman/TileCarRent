    ...
    <nav className="bg-white shadow-md">
        ...
        <div className="flex justify-between h-16">
          <div className="flex mx-16 gap-96">
            ...
            <div className="hidden md:ml-6 md:flex md:space-x-8">
              ...
              <Link to="/booking" className="text-gray-700 hover:text-green-600 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium">
                Booking
              </Link>
              <Link to="/aboutus" className="text-gray-700 hover:text-green-600 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium">
                About
              </Link>
            </div>
          </div>
      ...
      <div className="md:hidden" id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <Link to="/cars" className="text-gray-700 hover:text-green-600 block px-3 py-2 rounded-md text-base font-medium">
            Cars
          </Link>
          <Link to="/wedding-car" className="text-gray-700 hover:text-green-600 block px-3 py-2 rounded-md text-base font-medium">
            Wedding Car
          </Link>
          <Link to="/booking" className="text-gray-700 hover:text-green-600 block px-3 py-2 rounded-md text-base font-medium">
            Booking
          </Link>
          <Link to="/aboutus" className="text-gray-700 hover:text-green-600 block px-3 py-2 rounded-md text-base font-medium">
            About
          </Link>
        </div>
      </div>
