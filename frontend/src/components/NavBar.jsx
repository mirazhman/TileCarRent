    ...
    <nav className="bg-[#ded9d9] shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="-mr-2 flex items-center md:hidden">
            <button type="button" className="bg-gray-100 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-[var(--color-primary)] hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-green-600" aria-controls="mobile-menu" aria-expanded="false">
      ...
      <div className="md:hidden" id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <Link to="/" className="text-gray-700 hover:text-[var(--color-primary)] block px-3 py-2 rounded-md text-base font-medium">
            Home
          </Link>
          <Link to="/cars" className="text-gray-700 hover:text-[var(--color-primary)] block px-3 py-2 rounded-md text-base font-medium">
            Cars
          </Link>
          <Link to="/wedding-car" className="text-gray-700 hover:text-[var(--color-primary)] block px-3 py-2 rounded-md text-base font-medium">
            Wedding Car
          </Link>
          <Link to="/booking" className="text-gray-700 hover:text-[var(--color-primary)] block px-3 py-2 rounded-md text-base font-medium">
            Booking
          </Link>
          <Link to="/aboutus" className="text-gray-700 hover:text-[var(--color-primary)] block px-3 py-2 rounded-md text-base font-medium">
            About
          </Link>
        </div>
      </div>
