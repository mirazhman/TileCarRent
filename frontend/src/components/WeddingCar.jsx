  ...
  return (
    <div>
      ...
      <div className="container mx-auto py-16">
        <h2 className="text-3xl font-bold text-center mb-10">Our Wedding Cars</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Wedding Car 1 */}
          <div className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 shadow-md rounded-lg overflow-hidden">
            <img
